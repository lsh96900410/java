...
public class Member {
	...
	private int mAge;
	private char mMarried;
	private Date mRegdate;
	
	

	
	public Member(String mId, String mPassword, String mName, String mAddress, int mAge, char mMarried, Date mRegdate) {
		super();
		this.mId = mId;
	...
	public char getmMarried() {
		return mMarried;
	}

	public void setmMarried(char mMarried) {
		this.mMarried = mMarried;
	}
