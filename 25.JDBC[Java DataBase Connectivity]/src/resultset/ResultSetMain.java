...
public class ResultSetMain {
 //DataSource dataSource=new DataSource();
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("--------- ReseultSet.get타입(컬럼이름) ------------");
		...
		System.out.println("--------- ReseultSet.get타입(컬럼index) ------------");
		...
		System.out.println("--------- ReseultSet.getString(컬럼이름) ------------");
		rs = pstmt.executeQuery();
		while(rs.next()) {
		...
		System.out.println("--------- ReseultSet.getObject(컬럼이름) ------------");
		rs = pstmt.executeQuery();
		while(rs.next()) {
