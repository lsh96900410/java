...
abstract class AbstractParent{
	public void method1() {
		System.out.println("구상(Concrete) 메쏘드");
	}
...
class AbstractChild extends AbstractParent{
	@Override //재정의 강제 -> 재정의 x 시 일반클래스 불가 
	public void method2() {
		System.out.println("AbstractChild에서 AbstractParent의 추상메쏘드 method2()를 재정의 [implement(구현)]");
	}
}
...
public class AbstractParentChildMain {
	...
	public static void main(String[] args) {
		...
		//AbstractParent abstractParent = new AbstractParent();  ==> Cannot instantiate the type AbstractParent
