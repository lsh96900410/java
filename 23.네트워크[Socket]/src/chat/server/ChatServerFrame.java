...
public class ChatServerFrame extends JFrame {
		...
		*/
		...
		public void run() {
			try {
				...
				clientService.removeClinet(this);
			}
		}
	...
	public class ServerClientService {
		 ...
		 * 클라이언트객체 보관리스트
		 */
		private ArrayList<ServerClient> clientList=   // clientList.size() = 접속자수 
		 ...
		 * 클라이트객체삭제
		 */
		public void removeClinet(ServerClient client) {
